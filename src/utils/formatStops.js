                    ...
                    (d) =>
                        ...
                        (!(
                            ...
                            adjustTime(
                                ...
                                adjustTime(
                                    train.timetable._data[train.timetable.firstStationIndex]
                                        ?.departure,
                                )),
                );
        });
        if (beforeDiagram) {
            const before = beforeDiagram.railway.diagrams[0].trains
                .flat()
                .find(
                    (d) =>
                        d.number == train.number &&
                ...
                .some(
                    (d) =>
                        ...
                        (!(
                            ...
                            adjustTime(
                                d.timetable._data[d.timetable.firstStationIndex]?.departure,
                            ) >=
                                adjustTime(
                                    train.timetable._data[train.timetable.terminalStationIndex]
                                        ?.arrival ??
                                        train.timetable._data[train.timetable.terminalStationIndex]
                                            ?.departure,
                                )),
