...
/**
 * 2駅間の最短経路とその距離を返す
 * @param {string} start 出発駅ナンバリング
 * @param {string} goal 到着駅ナンバリング
...
/**
 * 2駅間の距離(営業キロ)を返す
 * @param {string} start ナンバリング
 * @param {string} goal ナンバリング
 * @returns {number} 距離(km)
 */
export default function findDistance(start, goal) {
